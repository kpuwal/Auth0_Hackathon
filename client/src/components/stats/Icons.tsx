...
export const HappyIcn = ({scale, posX, posY, opacity}: iconProp) => {
  return (
    <g
...
export const NeutralIcn = ({scale, posX, posY, opacity}: iconProp) => {
  return (
    <g
      transform={`translate(${posX}, ${posY}) scale(${scale} ${scale})`}
      style={{opacity: `${opacity}`}}>
...
export const NegativeIcn = ({scale, posX, posY, opacity}: iconProp) => {
  return (
    <g
      transform={`translate(${posX}, ${posY}) scale(${scale} ${scale})`}
      style={{opacity: `${opacity}`}}>
