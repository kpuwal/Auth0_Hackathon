...
const BarGroup = ({moods, label, sum, dominant}: IbarGroup) => {
  return (
    <svg width={280} height={210} viewBox={`30 0 220 170`} className="bar-group">
      <Bar
        id="positive"
        mood={moods.positive}
        barX={-60}
      ...
      <HappyIcn
        ...
        posX={142}
        posY={113}
        opacity={dominant.mood === "positive" ? 1 : .4} />
      ...
      <NeutralIcn
        ...
        posX={168}
        posY={113}
        opacity={dominant.mood === "neutral" ? 1 : .4} />
      ...
      <NegativeIcn
        ...
        posX={193}
        posY={113}
        opacity={dominant.mood === "negative" ? 1 : .4} />
